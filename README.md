...
Now you'll be making many many variables. You will be so very able! 

### Setup

Welcome to your first test-based assignment! It might take a bit to get used to reading your test feedback, but it would be well worth the effort!
...
- Run `npm install -g mocha`. (only once on your machine, and then from now on you won't need to run that code again)
